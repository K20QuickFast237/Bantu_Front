...
const JoinC = () => {
  ...
  return (
    <div className="max-w-full mx-20 p-6">
      {/* postes */}
      <div className="mb-6">
        <h3 className="text-blue-600 text-2xl font-medium mb-2">Rejoignez notre équipe</h3>
        <h2 className="text-black text-4xl mt-5  font-bold mb-7">Postes de vacances actuels</h2>
        ...
        {currentJobs.map((job, index) => (
          ...
          >
            <div className="flex-1">
              <h4 className="text-black font-semibold text-xl mb-1">{job.title}</h4>
              <p className="text-gray-500 text-lg">{job.subtitle}</p>
            </div>
      ...
      {/* en bas */}
      <div className="mt-8">
        <h3 className="text-green-600 text-2xl font-medium mb-2">Rejoignez notre vivier talent</h3>
